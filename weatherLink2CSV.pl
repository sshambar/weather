...
sub printHeader {
    print "#weatherlink v1.0\n";
    print "#date\ttime\tbarometer\ttempin\thumin\ttempout\thumout";
    print "\twindsamples\tavgwindsp\twinddir\thighwindsp\thighwinddir";
    print "\thighrainrate\trainrate\n"
#    print "\tet\tsolar\thighsolar\tforecast\n";
}
...
sub usage {
    die ("Usage: weatherLink2CSV.pl year month day hour minute\n"); 
}
